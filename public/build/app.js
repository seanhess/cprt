...
/** @jsx React.DOM */var ProjectPage = require('./projects/ProjectPage.jsx')
...
var Root = React.createClass({displayName: 'Root',
    ...
    pages: [
        {name: "Projects", component: ProjectPage(null )},
...
},{"./login.jsx":6,"./nav.jsx":7,"./projects/ProjectPage.jsx":12,"./test.jsx":14}],3:[function(require,module,exports){
...
module.exports = React.createClass({displayName: 'exports',
    render: function() {
        ...
        return (React.DOM.div( {className:"percent-box"}, 
            React.DOM.div( {className:"percent-box-background", style:styles},  " " ),
            React.DOM.div( {className:"percent-box-data"}, this.props.value)
        ))
    },
})
...
/** @jsx React.DOM */module.exports = React.createClass({displayName: 'exports',
    render: function() {
        return (React.DOM.div( {className:"project-details"}, 
            ...
            React.DOM.p(null, this.props.project.name),
            React.DOM.p(null, this.props.project.total, " Total Points"),
            React.DOM.p(null, 
                React.DOM.button( {onClick:this.pointMinus}, "-"),
                React.DOM.span(null, this.props.project.points),
                React.DOM.button( {onClick:this.pointPlus}, "+")
            ),
            React.DOM.div(null, 
                React.DOM.button( {onClick:this.onDelete}, "Delete Project")
            )
        ))
    },
...
/** @jsx React.DOM */var Project = require('./Project')

module.exports = React.createClass({displayName: 'exports',
    render: function() {
        return (React.DOM.form( {onSubmit:this.onSubmit}, 
            React.DOM.h3(null, "New Project"),
            React.DOM.div(null, React.DOM.input( {type:"text", ref:"name"}), " Name"),
            React.DOM.div(null, React.DOM.input( {type:"number", ref:"points"}), " Points Required"),
...
},{"./Project":8}],11:[function(require,module,exports){
/** @jsx React.DOM */var ProjectRow = require('./ProjectRow.jsx')
...
},{"./ProjectRow.jsx":13}],12:[function(require,module,exports){
...
},{"../components/PointBars.jsx":3,"../components/progress.jsx":4,"../firebase":5,"./ProjectDetails.jsx":9,"./ProjectForm.jsx":10,"./ProjectList.jsx":11,"./ProjectRow.jsx":13}],13:[function(require,module,exports){
/** @jsx React.DOM */var Progress = require('../components/progress.jsx')
var PointBars = require('../components/PointBars.jsx')
...
module.exports = React.createClass({displayName: 'exports',
    render: function() {
        ...
        return (React.DOM.div( {className:"table-row", onClick:this.onClick}, 
            ...
            React.DOM.div( {className:"row-data"}, 
...
},{"../components/PointBars.jsx":3,"../components/progress.jsx":4,"./Project":8}],14:[function(require,module,exports){
/** @jsx React.DOM */
module.exports = React.createClass({displayName: 'exports',
